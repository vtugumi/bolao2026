...
const teamsData = [
  ...
  { name: 'Tchequia', code: 'CZE', flagEmoji: '🇨🇿', groupLabel: 'A' },
  ...
  { name: 'Bosnia e Herzegovina', code: 'BIH', flagEmoji: '🇧🇦', groupLabel: 'B' },
  ...
  { name: 'Turquia', code: 'TUR', flagEmoji: '🇹🇷', groupLabel: 'D' },
  ...
  { name: 'Suecia', code: 'SWE', flagEmoji: '🇸🇪', groupLabel: 'F' },
  ...
  { name: 'Iraque', code: 'IRQ', flagEmoji: '🇮🇶', groupLabel: 'I' },
  ...
  { name: 'RD Congo', code: 'COD', flagEmoji: '🇨🇩', groupLabel: 'K' },
